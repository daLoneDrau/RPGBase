 ...
 * pair of vertices. An directed graph is a graph where all edges are
 * unidirectional.
 * @author drau
 */
public class EdgeWeightedDirectedGraph {
    ...
    /**
     * Creates a new instance of {@link EdgeWeightedDirectedGraph} from an
     * existing source.
     * @param g the graph being cloned
     */
    public EdgeWeightedDirectedGraph(final EdgeWeightedDirectedGraph g) {
     ...
     */
    public EdgeWeightedDirectedGraph(final InputStream in) throws Exception {
        // TODO Auto-generated method stub
    }
    /**
     * Creates a new instance of {@link EdgeWeightedDirectedGraph} with a
     * specific number of vertices and no edges.
     * @param numVertices the number of vertices
     * @throws RPGException if an error occurs
     */
    public EdgeWeightedDirectedGraph(final int numVertices) 
    		throws RPGException {
    ...
    public EdgeWeightedDirectedGraph(final EdgeWeightedUndirectedGraph g)
    		throws RPGException {
        vertices = new GraphNode[g.getNumberOfVertices()];
        for (int i = 0, len = g.getNumberOfVertices(); i < len; i++) {
            vertices[i] = new GraphNode(i);
        }
        edges = new WeightedGraphEdge[0];
	}
