...
public class CombatUtility {
     ...
     */
    public float ARX_DAMAGES_DealDamages(final BaseInteractiveObject targetIO,
    		final float dmg, final BaseInteractiveObject sourceIO,
    ...
    public float ARX_DAMAGES_DealDamages(final int target, final float dmg,
    	...
    	return ARX_DAMAGES_DealDamages(Interactive.getInstance().getIO(target),
    			dmg,
     ...
     * @param sourceIO the {@link BaseInteractiveObject} that is the source of
     * the damage
     ...
     */
    protected float damageByType(final BaseInteractiveObject sourceIO,
     ...
     * @throws RPGException if an error occurs
     */
    protected int getIOWeaponDamage(final BaseInteractiveObject io) throws RPGException {
    	int dmg = 1;
    	int wpnId = -1;
    	...
    	if (Interactive.getInstance().hasIO(wpnId)) {
    	    BaseInteractiveObject wpnIO = Interactive.getInstance().getIO(wpnId);
