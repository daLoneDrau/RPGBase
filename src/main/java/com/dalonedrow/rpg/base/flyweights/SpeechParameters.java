...
public class SpeechParameters {
     ...
     */
    public SpeechParameters(final String initParams, final String spName) {
     ...
     */
    public boolean isKillAllSpeech() {
     ...
     */
    public void setKillAllSpeech(boolean flag) {
        killAllSpeech = flag;
    }
    /**
