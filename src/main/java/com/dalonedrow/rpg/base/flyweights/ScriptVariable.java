...
public final class ScriptVariable {
	...
	public ScriptVariable(final String newName, final int newType,
			final Object value) throws RPGException {
		if (newName == null) {
	 ...
	 * @throws RPGException if the type is invalid
	 */
	public ScriptVariable(final ScriptVariable clone) throws RPGException {
		if (clone == null) {
	 ...
	 * @throws RPGException if the type is invalid
	 */
	public float getFloatArrayVal(final int index) throws RPGException {
		if (type != ScriptConstants.TYPE_G_03_FLOAT_ARR
				&& type != ScriptConstants.TYPE_L_11_FLOAT_ARR) {
			throw new RPGException(
					ErrorMessage.INTERNAL_ERROR, "Not a floating-point array");
	 ...
	 * @throws RPGException if the type is invalid
	 */
	public int getIntArrayVal(final int index) throws RPGException {
		if (type != ScriptConstants.TYPE_G_05_INT_ARR
				&& type != ScriptConstants.TYPE_L_13_INT_ARR) {
			throw new RPGException(
					ErrorMessage.INTERNAL_ERROR, "Not an integer array");
	 ...
	 * @throws RPGException if the type is invalid
	 */
	public long getLongArrayVal(final int index) throws RPGException {
		if (type != ScriptConstants.TYPE_G_07_LONG_ARR
				&& type != ScriptConstants.TYPE_L_15_LONG_ARR) {
			throw new RPGException(
					ErrorMessage.INTERNAL_ERROR, "Not an long integer array");
	 ...
	 * @throws RPGException if the type is invalid
	 */
	public String getTextArrayVal(final int index) throws RPGException {
		if (type != ScriptConstants.TYPE_G_01_TEXT_ARR
				&& type != ScriptConstants.TYPE_L_09_TEXT_ARR) {
			throw new RPGException(
					ErrorMessage.INTERNAL_ERROR, "Not a string array");
	 ...
	 * @throws RPGException if the type is invalid
	 */
	public void set(final Object value) throws RPGException {
		boolean throwException = false;
		switch (type) {
	 ...
	 */
	public void setName(final String value) throws RPGException {
		if (value == null) {
			throw new RPGException(
					ErrorMessage.BAD_PARAMETERS, "Name field is null.");
		}
	 ...
	 * @throws RPGException if the type is invalid
	 */
	public void setType(final int val) throws PooledException, RPGException {
		type = val;
		validateType();
		clear();
	}
