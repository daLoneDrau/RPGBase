...
public abstract class IoNpcData<IO extends BaseInteractiveObject>
	 ...
	 */
	public void setArmorClass(final float armorClass) {
	 ...
	 * @param movemode the new value to set
	 */
	 ...
	 * @param reachedtarget the new value to set
	 */
	public void setReachedtarget(final long reachedtarget) {
	 ...
	 * @param tactics the new value to set
	 */
	public void setTactics(final int tactics) {
	 ...
	 * @param xpvalue the new value to set
	 */
	public void setXpvalue(final int xpvalue) {
